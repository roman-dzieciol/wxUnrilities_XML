...
#define UXP_CLASS cfgNativeFunc


// ============================================================================
// cfgNativeFunctions
// ============================================================================
cfgNativeFunc::cfgNativeFunc( wxFileName filename, pkgNativeFuncMap* funcmap )
{
    ...
    // add package
    root_package->AddCmdPostParse( UXC_PROC_1(funcmap, &pkgNativeFuncMap::AddPackage, UXS_GET(CurrentPackage)) );
